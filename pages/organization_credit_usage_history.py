...
def org_credit_usage():
    ...
    ORDER BY 1;"""
       ...
       # Generated by Snowflake Copilot
    # Execute the query
    wh_credits_l30_df = session.sql(wh_credits_l30_sql).to_pandas()
    compute_credits_l30_df = session.sql(compute_credits_l30_sql).to_pandas()
    cs_credits_l30_df = session.sql(cs_credits_l30_sql).to_pandas()
    compute_credits_l7_df = session.sql(compute_credits_l7_sql).to_pandas()
    wh_credits_l7_df = session.sql(wh_credits_l7_sql).to_pandas()
    cs_credits_l7_df = session.sql(cs_credits_l7_sql).to_pandas()
    compute_credits_l1_df = session.sql(compute_credits_l1_sql).to_pandas()
    wh_credits_l1_df = session.sql(wh_credits_l1_sql).to_pandas()
    cs_credits_l1_df = session.sql(cs_credits_l1_sql).to_pandas()
    ...
    credits_fig.add_trace(
        go.Indicator(
            mode="number+delta",
            value=wh_credits_l30_df['CREDITS_USED_LAST_PERIOD'].iloc[0],
            title={"text": "Warehouse Credits Used<br>Last 30 Days"},
            delta={'reference': wh_credits_l30_df['CREDITS_USED_PRIOR_PERIOD'].iloc[0]},
        ),
        row=1, col=2
    )
    ...
    credits_fig.add_trace(
        go.Indicator(
            mode="number+delta",
            value=wh_credits_l7_df['CREDITS_USED_LAST_PERIOD'].iloc[0],
            title={"text": "Warehouse Credits Used<br>Last 7 Days"},
            delta={'reference': wh_credits_l7_df['CREDITS_USED_PRIOR_PERIOD'].iloc[0]},
        ),
        row=2, col=2
    )
    ...
    credits_fig.add_trace(
        go.Indicator(
            mode="number+delta",
            value=wh_credits_l1_df['CREDITS_USED_LAST_PERIOD'].iloc[0],
            title={"text": "Warehouse Credits Used<br>Last 1 Day"},
            delta={'reference': wh_credits_l1_df['CREDITS_USED_PRIOR_PERIOD'].iloc[0]},
        ),
        row=3, col=2
    )
    ...
    credits_fig.add_trace(
        go.Indicator(
            mode="number+delta",
            value=cs_credits_l30_df['CREDITS_USED_LAST_PERIOD'].iloc[0],
            title={"text": "Cloud Servcies Credits Used<br>Last 30 Days"},
            delta={'reference': cs_credits_l30_df['CREDITS_USED_PRIOR_PERIOD'].iloc[0]},
        ),
        row=1, col=3
    )
    ...
    credits_fig.add_trace(
        go.Indicator(
            mode="number+delta",
            value=cs_credits_l7_df['CREDITS_USED_LAST_PERIOD'].iloc[0],
            title={"text": "Cloud Servcies Credits Used<br>Last 7 Days"},
            delta={'reference': cs_credits_l7_df['CREDITS_USED_PRIOR_PERIOD'].iloc[0]},
        ),
        row=2, col=3
    )
    ...
    credits_fig.add_trace(
        go.Indicator(
            mode="number+delta",
            value=cs_credits_l1_df['CREDITS_USED_LAST_PERIOD'].iloc[0],
            title={"text": "Cloud Servcies Credits Used<br>Last 1 Day"},
            delta={'reference': cs_credits_l1_df['CREDITS_USED_PRIOR_PERIOD'].iloc[0]},
        ),
        row=3, col=3
    )
